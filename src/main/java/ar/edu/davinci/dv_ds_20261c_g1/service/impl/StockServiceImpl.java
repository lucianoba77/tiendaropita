...
public class StockServiceImpl implements StockService {
    ...
    public Stock establecer(Prenda prenda, Integer cantidad) throws BusinessException {
        ...
        return doEstablecer(prenda, cantidad, null);
    ...
    public Stock establecer(Prenda prenda, Integer cantidad, Integer stockMinimo) throws BusinessException {
        ...
        return doEstablecer(prenda, cantidad, stockMinimo);

    }



    private Stock doEstablecer(Prenda prenda, Integer cantidad, Integer stockMinimo) throws BusinessException {
    ...
    public void descontar(Long prendaId, Integer cantidad) throws BusinessException {
        ...
        doDescontar(prendaId, cantidad, null);
    ...
    public void descontar(Long prendaId, Integer cantidad, Long ventaId) throws BusinessException {
        ...
        doDescontar(prendaId, cantidad, ventaId);

    }



    private void doDescontar(Long prendaId, Integer cantidad, Long ventaId) throws BusinessException {
    ...
    public void reponer(Long prendaId, Integer cantidad) {
        ...
        doReponer(prendaId, cantidad, null);
    ...
    public void reponer(Long prendaId, Integer cantidad, Long ventaId) {
        ...
        doReponer(prendaId, cantidad, ventaId);

    }



    private void doReponer(Long prendaId, Integer cantidad, Long ventaId) {
